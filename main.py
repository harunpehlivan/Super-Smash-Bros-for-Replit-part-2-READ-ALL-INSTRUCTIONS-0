...
#MushroomEffect
P1MushroomEffect = False
P2MushroomEffect = False
...
TitleFontShadow  = pygame.font.SysFont("Comic Sans MS",30)
...
#Texts
  #Title
Title = TitleFont.render("Super Smash Bros for Scratch 2",False,(0,0,0))
TitleShadow = TitleFontShadow.render("Super Smash Bros for Scratch 2",False,(255,255,255))
  #CHOOSE YOUR FIGHTERS
...
def MushroomEffect(Player,Mushroom,Character):
  if Character == "Mario":
      Player.width = 96
      Player.height = 180
      Player.img = pygame.transform.scale(Player.img,(96,180))

  if Character == "DK":
      Player.img = pygame.transform.scale(Player.img,(162,206))
      Player.width = 162
      Player.height = 206

  if Character == "Link":
        Player.img = pygame.transform.scale(Player.img,(108,192))
        Player.width = 108
        Player.height = 192

  if Character == "Samus":
        Player.img = pygame.transform.scale(Player.img,(114,192))
        Player.width = 114
        Player.height = 192

  if Character == "Yoshi":
        Player.img = pygame.transform.scale(Player.img,(120,180))
        Player.width = 120
        Player.height = 180

  if Character == "Kirby":
        Player.img = pygame.transform.scale(Player.img,(120,140))
        Player.width = 120
        Player.height = 140

  if Character == "Fox":
        Player.img = pygame.transform.scale(Player.img,(92,174))
        Player.width = 92
        Player.height = 174

  if Character == "Pikachu":
        Player.img = pygame.transform.scale(Player.img,(130,146))
        Player.width = 130
        Player.height = 146

  if Character == "Luigi":
      Player.img = pygame.transform.scale(Player.img,(84,186))
      Player.width = 84
      Player.height = 186

  if Character == "CaptainFalcon":
      Player.img = pygame.transform.scale(Player.img,(130,196))
      Player.width = 130
      Player.height = 196

  if Character == "Peach":
      Player.img = pygame.transform.scale(Player.img,(110,194))
      Player.width = 110
      Player.height = 194

  if Character == "Bowser":
      Player.img = pygame.transform.scale(Player.img,(280,280))
      Player.width = 280
      Player.height = 280

  if Character == "Ganon":
      Player.img = pygame.transform.scale(Player.img,(214,240))
      Player.width = 214
      Player.height = 240

  if Character == "Mewtwo":
      Player.img = pygame.transform.scale(Player.img,(168,210))
      Player.width = 168
      Player.height = 210

  if Character == "MetaKnight":
      Player.img = pygame.transform.scale(Player.img,(140,150))
      Player.width = 140
      Player.height = 150
  ...
  if Character == "Charizard":
      Player.img = pygame.transform.scale(Player.img,(216,216))
      Player.width = 216
      Player.height = 216

  if Character == "DiddyKong":
      Player.img = pygame.transform.scale(Player.img,(144,160))
      Player.width = 144
      Player.height = 160

  if Character == "Sonic":
      Player.img = pygame.transform.scale(Player.img,(120,176))
      Player.width = 120
      Player.height = 176
  ...
  if Character == "MegaMan":
      Player.img = pygame.transform.scale(Player.img,(192,180))
      Player.width = 192
      Player.height = 180
  ...
  if Character == "PacMan":
      Player.img = pygame.transform.scale(Player.img,(120,162))
      Player.width = 120
      Player.height = 162

  if Character == "Inkling":
      Player.img = pygame.transform.scale(Player.img,(160,160))
      Player.width = 160
      Player.height = 160

  if Character == "Ridley":
      Player.img = pygame.transform.scale(Player.img,(338,240))
      Player.width = 338
      Player.height = 240

  if Character == "KingKRool":
      Player.img = pygame.transform.scale(Player.img,(210,240))
      Player.width = 210
      Player.height = 240

  if Character == "Banjo":
      Player.img = pygame.transform.scale(Player.img,(192,192))
      Player.width = 192
      Player.height = 192

  if Character == "Steve":
      Player.img = pygame.transform.scale(Player.img,(126,170))
      Player.width = 126
      Player.height = 170

  if Character == "Kazuya":
      Player.img = pygame.transform.scale(Player.img,(160,200))
      Player.width = 160
      Player.height = 200

  if Character == "Waluigi":
      Player.img = pygame.transform.scale(Player.img,(84,216))
      Player.width = 84
      Player.height = 216


  if Character == "Tails":
      Player.img = pygame.transform.scale(Player.img,(150,164))
      Player.width = 150
      Player.height = 164

  if Character == "Knuckles":
      Player.img = pygame.transform.scale(Player.img,(188,188))
      Player.width = 188
      Player.height = 188

  if Character == "Eggman":
      Player.img = pygame.transform.scale(Player.img,(198,234))
      Player.width = 198
      Player.height = 234

  if Character == "Roblox":
      Player.img = pygame.transform.scale(Player.img,(140,180))
      Player.width = 140
      Player.height = 180

  if Character == "Sans":
      Player.img = pygame.transform.scale(Player.img,(170,170))
      Player.width = 170
      Player.height = 170

  if Character == "Decidueye":
      Player.img = pygame.transform.scale(Player.img,(180,192))
      Player.width = 180
      Player.height = 192

  

  '''if P1MushroomEffect == False:
    if Character == "Mario":
      Player.width = 48
      Player.height = 90
      Player.img = pygame.transform.scale(Player.img,(48,90))'''
...
#Title screen
Play = GameObject(220,120,75,75,"Assets/TitleScreen/Play.png")

#P1Selects(Spaces 20 in the X)
P1Mario = GameObject(50,75,40,40,"Assets/CharacterSelects/MarioSel.png")

P1DK = GameObject(91,75,40,40,"Assets/CharacterSelects/DKSel.png")

P1Link = GameObject(132,75,40,40,"Assets/CharacterSelects/LinkSel.png")

P1Samus = GameObject(173,75,40,40,"Assets/CharacterSelects/SamusSel.png")

P1Yoshi = GameObject(214,75,40,40,"Assets/CharacterSelects/YoshiSel.png")

P1Kirby = GameObject(255,75,40,40,"Assets/CharacterSelects/KirbySel.png")

P1Fox = GameObject(296,75,40,40,"Assets/CharacterSelects/FoxSel.png")

P1Pikachu = GameObject(337,75,40,40,"Assets/CharacterSelects/PikachuSel.png")

P1Luigi = GameObject(378,75,40,40,"Assets/CharacterSelects/LuigiSel.png")

P1CaptainFalcon = GameObject(50,116,40,40,"Assets/CharacterSelects/CaptainFalconSel.png")

P1Peach = GameObject(91,116,40,40,"Assets/CharacterSelects/PeachSel.png")

P1Bowser = GameObject(132,116,40,40,"Assets/CharacterSelects/BowserSel.png")

P1Ganon = GameObject(173,116,40,40,"Assets/CharacterSelects/GanonSel.png")

P1Mewtwo = GameObject(214,116,40,40,"Assets/CharacterSelects/MewtwoSel.png")

P1MetaKnight = GameObject(255,116,40,40,"Assets/CharacterSelects/MetaKnightSel.png")

P1Wario = GameObject(296,116,40,40,"Assets/CharacterSelects/WarioSel.png")

P1Charizard = GameObject(337,116,40,40,"Assets/CharacterSelects/CharizardSel.png")

P1DiddyKong = GameObject(378,116,40,40,"Assets/CharacterSelects/DiddyKongSel.png")

P1Sonic = GameObject(50,157,40,40,"Assets/CharacterSelects/SonicSel.png")

P1KingDedede = GameObject(91,157,40,40,"Assets/CharacterSelects/KingDededeSel.png")

P1MegaMan= GameObject(132,157,40,40,"Assets/CharacterSelects/MegaManSel.png")

P1Greninja= GameObject(173,157,40,40,"Assets/CharacterSelects/GreninjaSel.png")

P1PacMan= GameObject(214,157,40,40,"Assets/CharacterSelects/PacManSel.png")

P1Inkling= GameObject(255,157,40,40,"Assets/CharacterSelects/InklingSel.png")

P1Ridley= GameObject(296,157,40,40,"Assets/CharacterSelects/RidleySel.png")

P1KingKRool= GameObject(337,157,40,40,"Assets/CharacterSelects/KingKRoolSel.png")

P1Banjo = GameObject(378,157,40,40,"Assets/CharacterSelects/BanjoSel.png")

P1Steve = GameObject(50,198,40,40,"Assets/CharacterSelects/SteveSel.png")

P1Kazuya = GameObject(91,198,40,40,"Assets/CharacterSelects/KazuyaSel.png")

P1Waluigi = GameObject(132,198,40,40,"Assets/CharacterSelects/WaluigiSel.png")

P1Tails = GameObject(173,198,40,40,"Assets/CharacterSelects/TailsSel.png")

P1Knuckles = GameObject(214,198,40,40,"Assets/CharacterSelects/KnucklesSel.png")

P1Eggman = GameObject(255,198,40,40,"Assets/CharacterSelects/EggmanSel.png")

P1Roblox = GameObject(296,198,40,40,"Assets/CharacterSelects/RobloxSel.png")

P1Sans = GameObject(337,198,40,40,"Assets/CharacterSelects/SansSel.png")

P1Decidueye = GameObject(378,198,40,40,"Assets/CharacterSelects/DecidueyeSel.png")


#P2Selects
P2Mario = GameObject(50,75,40,40,"Assets/CharacterSelects/MarioSel.png")

P2DK = GameObject(91,75,40,40,"Assets/CharacterSelects/DKSel.png")

P2Link = GameObject(132,75,40,40,"Assets/CharacterSelects/LinkSel.png")

P2Samus = GameObject(173,75,40,40,"Assets/CharacterSelects/SamusSel.png")

P2Yoshi = GameObject(214,75,40,40,"Assets/CharacterSelects/YoshiSel.png")

P2Kirby = GameObject(255,75,40,40,"Assets/CharacterSelects/KirbySel.png")

P2Fox = GameObject(296,75,40,40,"Assets/CharacterSelects/FoxSel.png")

P2Pikachu = GameObject(337,75,40,40,"Assets/CharacterSelects/PikachuSel.png")

P2Luigi = GameObject(378,75,40,40,"Assets/CharacterSelects/LuigiSel.png")
P2CaptainFalcon = GameObject(50,116,40,40,"Assets/CharacterSelects/CaptainFalconSel.png")

P2Peach = GameObject(91,116,40,40,"Assets/CharacterSelects/PeachSel.png")

P2Bowser = GameObject(132,116,40,40,"Assets/CharacterSelects/BowserSel.png")

P2Ganon = GameObject(173,116,40,40,"Assets/CharacterSelects/GanonSel.png")

P2Mewtwo = GameObject(214,116,40,40,"Assets/CharacterSelects/MewtwoSel.png")

P2MetaKnight = GameObject(255,116,40,40,"Assets/CharacterSelects/MetaKnightSel.png")

P2Wario = GameObject(296,116,40,40,"Assets/CharacterSelects/WarioSel.png")

P2Charizard = GameObject(337,116,40,40,"Assets/CharacterSelects/CharizardSel.png")

P2DiddyKong = GameObject(378,116,40,40,"Assets/CharacterSelects/DiddyKongSel.png")

P2Sonic = GameObject(50,157,40,40,"Assets/CharacterSelects/SonicSel.png")

P2KingDedede = GameObject(91,157,40,40,"Assets/CharacterSelects/KingDededeSel.png")

P2MegaMan= GameObject(132,157,40,40,"Assets/CharacterSelects/MegaManSel.png")

P2Greninja= GameObject(173,157,40,40,"Assets/CharacterSelects/GreninjaSel.png")

P2PacMan= GameObject(214,157,40,40,"Assets/CharacterSelects/PacManSel.png")

P2Inkling= GameObject(255,157,40,40,"Assets/CharacterSelects/InklingSel.png")

P2Ridley= GameObject(296,157,40,40,"Assets/CharacterSelects/RidleySel.png")

P2KingKRool= GameObject(337,157,40,40,"Assets/CharacterSelects/KingKRoolSel.png")

P2Banjo = GameObject(378,157,40,40,"Assets/CharacterSelects/BanjoSel.png")

P2Steve = GameObject(50,198,40,40,"Assets/CharacterSelects/SteveSel.png")

P2Kazuya = GameObject(91,198,40,40,"Assets/CharacterSelects/KazuyaSel.png")

P2Waluigi = GameObject(132,198,40,40,"Assets/CharacterSelects/WaluigiSel.png")

P2Tails = GameObject(173,198,40,40,"Assets/CharacterSelects/TailsSel.png")

P2Knuckles = GameObject(214,198,40,40,"Assets/CharacterSelects/KnucklesSel.png")

P2Eggman = GameObject(255,198,40,40,"Assets/CharacterSelects/EggmanSel.png")

P2Roblox = GameObject(296,198,40,40,"Assets/CharacterSelects/RobloxSel.png")

P2Sans = GameObject(337,198,40,40,"Assets/CharacterSelects/SansSel.png")

P2Decidueye = GameObject(378,198,40,40,"Assets/CharacterSelects/DecidueyeSel.png")


#BackgroundSelects
MarioLand = GameObject(0,50,250,100,"Assets/BackGroundSelects/MarioBackground.png")
FinalDestinationSel = GameObject(0,150,250,100,"Assets/BackGroundSelects/FinalDestinationSel.png")
Brinstar = GameObject(250,50,250,100,"Assets/BackGroundSelects/BrinstarSel.png")
GreenHillZoneSel = GameObject(250,150,250,100,"Assets/BackGroundSelects/GreenHillZoneSel.png")

#Backgrounds
FinalDestination = GameObject(0,0,500,250,"Assets/Backgrounds/FinalDestination.PNG")
PalmTrees = GameObject(0,0,500,255,"Assets/Backgrounds/PalmTrees.png")

#Ground
Ground = GameObject(50,150,400,100,"Assets/Grounds/MarioGround.png")

#Players
Player1 = GameObject(125,10,50,50,"Assets/Characters/Mario/Mario.png")
Player2 = GameObject(325,10,50,50,"Assets/Characters/Mario/Mario.png")

#Items(The y values are higher than usual because I am using gravity to determine when they should and should not appear)
Mushroom = GameObject(265,-1300000,50,50,"Assets/Items/Mushroom.png")

BadMushroom = GameObject(160,-1500000,50,50,"Assets/Items/PoisonMushroom.png")
  
Burger = GameObject(225,-1000000,50,50,"Assets/Items/Burger.png")


#EndScreen
Replay = GameObject(220,120,75,75,"Assets/Winners/Restart.png")
...
#Moves the projectiles
    ...
    if event.type == pygame.MOUSEBUTTONDOWN:
      ...
      #P1Selects
        ...
        if P1Mario.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(48,90))
          Player1.width = 48
          Player1.height = 90
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1DK.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(81,103))
          Player1.width = 81
          Player1.height = 103
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Link.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(54,96))
          Player1.width = 54
          Player1.height = 96
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Samus.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(57,96))
          Player1.width = 57
          Player1.height = 96
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Yoshi.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(60,90))
          Player1.width = 60
          Player1.height = 90
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Kirby.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(60,70))
          Player1.width = 60
          Player1.height = 70
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Fox.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(46,87))
          Player1.width = 46
          Player1.height = 87
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Pikachu.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(65,73))
          Player1.width = 65
          Player1.height = 73
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Luigi.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(42,93))
          Player1.width = 42
          Player1.height = 93
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1CaptainFalcon.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(65,98))
          Player1.width = 65
          Player1.height = 98
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Peach.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(55,97))
          Player1.width = 55
          Player1.height = 97
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Bowser.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(140,140))
          Player1.width = 140
          Player1.height = 140
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Ganon.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(107,120))
          Player1.width = 107
          Player1.height = 120
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Mewtwo.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(84,105))
          Player1.width = 84
          Player1.height = 105
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1MetaKnight.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(70,75))
          Player1.width = 70
          Player1.height = 75
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Charizard.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(108,108))
          Player1.width = 108
          Player1.height = 108
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1DiddyKong.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(72,80))
          Player1.width = 72
          Player1.height = 80
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Sonic.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(60,88))
          Player1.width = 60
          Player1.height = 88
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1MegaMan.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(96,90))
          Player1.width = 96
          Player1.height = 90
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Greninja.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(70,70))
          Player1.width = 70
          Player1.height = 70
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1PacMan.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(60,81))
          Player1.width = 60
          Player1.height = 81
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Inkling.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(80,80))
          Player1.width = 80
          Player1.height = 80
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Ridley.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(169,120))
          Player1.width = 169
          Player1.height = 120
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1KingKRool.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(105,120))
          Player1.width = 105
          Player1.height = 120
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Banjo.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(96,96))
          Player1.width = 96
          Player1.height = 96
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Steve.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(63,85))
          Player1.width = 63
          Player1.height = 85
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Kazuya.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(80,100))
          Player1.width = 80
          Player1.height = 100
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Waluigi.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(42,108))
          Player1.width = 42
          Player1.height = 108
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Tails.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(75,82))
          Player1.width = 75
          Player1.height = 82
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Knuckles.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(94,94))
          Player1.width = 94
          Player1.height = 94
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Eggman.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(99,117))
          Player1.width = 99
          Player1.height = 117
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Roblox.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(70,90))
          Player1.width = 70
          Player1.height = 90
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Sans.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(85,85))
          Player1.width = 85
          Player1.height = 85
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
        ...
        if P1Decidueye.Clicked() == True:
          ...
          Player1.img = pygame.transform.scale(Player1.img,(90,96))
          Player1.width = 90
          Player1.height = 96
          Player1.img_flip = pygame.transform.flip(Player1.img, True, False)
  ...
  if Page == "P1Sel":
    ...
    screen.blit(ChooseYourFighterP1Shadow,(148,20))
    screen.blit(ChooseYourFighterP1,(150,20))

    SelectPanel = pygame.Rect(0,50,500,250)
  ...
  if Page == "P2Sel":
    screen.fill((255,255,255))
    screen.blit(ChooseYourFighterP2Shadow,(148,20))
    screen.blit(ChooseYourFighterP2,(150,20))
  ...
  if Page == "Game":
    screen.fill((0,0,0))
    Lava = pygame.Rect(0,220,500,30)
    Water = pygame.Rect(0,220,500,30)
    ...
    #Draws all of the items(We will use gravity to make the items start off at a very high hight and that will determine when it is supposed to spawn)
    screen.blit(Burger.img,(Burger.x,Burger.y))
    screen.blit(BadMushroom.img,(BadMushroom.x,BadMushroom.y))
    screen.blit(Mushroom.img,(Mushroom.x,Mushroom.y))

    #Burger
    CollisionGround(Burger,Ground)
    collide_platform = False
    CollisionGround(Burger,Ground)
    collide_platform = True in Burger.collision
  
    if collide_platform == False:
      Burger.InAir = True
  
    if Burger.InAir == True:
      Burger.vy = Burger.vy + Gravity
    Burger.y += Burger.vy
    
    Burger.check_collision(Player1.hitbox)
    for i in range(len(Burger.collision)):
      if Burger.collision[i] and Player1Hits == True and not(Player1HealthWidth >= 100):
        Player1HealthWidth += 5
        Burger.y = -1000000

    Burger.check_collision(Player2.hitbox)
    for i in range(len(Burger.collision)):
      if Burger.collision[i] and Player2Hits == True and not(Player2HealthWidth >= 100):
        Player2HealthWidth += 5
        Burger.y = -1000000
    ...
    #Mushroom
    CollisionGround(Mushroom,Ground)
    collide_platform = False
    CollisionGround(Mushroom,Ground)
    collide_platform = True in Mushroom.collision
  
    if collide_platform == False:
      Mushroom.InAir = True
  
    if Mushroom.InAir == True:
      Mushroom.vy = Mushroom.vy + Gravity
    Mushroom.y += Mushroom.vy
    
    Mushroom.check_collision(Player1.hitbox)
    for i in range(len(Mushroom.collision)):
      if Mushroom.collision[i] and Player1Hits == True:
        P1MushroomEffect = True
        Mushroom.y = -1300000
        Player1.x -= 25
        Player1.y -= 70
        MushroomEffectStart2 = get_time()

    if P1MushroomEffect == True:
        MushroomEffect(Player1,Mushroom,Character1)
        MushroomEffectTotal2 = get_time()-MushroomEffectStart2
        if MushroomEffectTotal2 >= 5000:
          P1MushroomEffect = False
          Shrink(Player1,Character1)


    Mushroom.check_collision(Player2.hitbox)
    for i in range(len(Mushroom.collision)):
      if Mushroom.collision[i] and Player2Hits == True:
        P2MushroomEffect = True
        Mushroom.y = -1300000
        Player2.x -= 25
        Player2.y -= 70
        MushroomEffectStart = get_time()
        #MushroomEffectFinish = get_time()

    if P2MushroomEffect == True:
      MushroomEffect(Player2,Mushroom,Character2)
      MushroomEffectTotal = get_time()-MushroomEffectStart
      if MushroomEffectTotal >= 5000:
        P2MushroomEffect = False
        Shrink(Player2,Character2)
    ...
    #BadMushroom
    CollisionGround(BadMushroom,Ground)
    collide_platform = False
    CollisionGround(BadMushroom,Ground)
    collide_platform = True in BadMushroom.collision
  
    if collide_platform == False:
      BadMushroom.InAir = True
  
    if BadMushroom.InAir == True:
      BadMushroom.vy = BadMushroom.vy + Gravity
    BadMushroom.y += BadMushroom.vy

    Burger.check_collision(Player1.hitbox)
    for i in range(len(BadMushroom.collision)):
      if BadMushroom.collision[i] and Player1Hits == True:
        Player1HealthWidth -= 5
        BadMushroom.y = -1500000

    BadMushroom.check_collision(Player2.hitbox)
    for i in range(len(BadMushroom.collision)):
      if BadMushroom.collision[i] and Player2Hits == True:
        Player2HealthWidth -= 5
        BadMushroom.y = -1500000
        
    if BadMushroom.y >= 100:
      BadMushroom.y = 100
    ...
    Player2.UpdateHitbox()
    Burger.UpdateHitbox()
    BadMushroom.UpdateHitbox()
    Mushroom.UpdateHitbox()
    ...
    if P1Projectile == True:
      ...
      if ProjectilePlayer1.x > 475 or ProjectilePlayer1.x < 0:
        P1Projectile = False
    ...
    if P2Projectile == True:
      ...
      if ProjectilePlayer2.x > 475 or ProjectilePlayer2.x < 0:
        P2Projectile = False
    if P2Projectile == False:
    ...
    #Health
    screen.blit(P1HP,(130,0))
    Player1Damage = pygame.Rect(100,20,100,15)
    Player1Health = pygame.Rect(100,20,Player1HealthWidth,15)
    pygame.draw.rect(screen,[255,0,0],Player1Damage)
    pygame.draw.rect(screen,[0,155,0],Player1Health)

    screen.blit(P2HP,(330,0))
    Player2Damage = pygame.Rect(300,20,100,15)
    Player2Health = pygame.Rect(300,20,Player2HealthWidth,15)
    ...
    for i in range(len(Player1.collision)):
      if Player1.collision[i] and Player1Hits == True:
        if P1MushroomEffect == False:
          Player2HealthWidth -= 0.1
        if P1MushroomEffect == True:
          Player2HealthWidth -= 0.2
        if Player1.FacingRight == True:
          Player2.x += 5
          Player2.y -=5
    ...
    for i in range(len(Player2.collision)):
      if Player2.collision[i] and Player2Hits == True:
        if P2MushroomEffect == False:
          Player1HealthWidth -= 0.1
        if P2MushroomEffect == True:
          Player1HealthWidth -= 0.2
        if Player2.FacingRight == True:
          Player1.x += 5
          Player1.y -=5
  ...
  if Page == "Player1Win":
    ...
    screen.blit(Player1Wins,(150,20))
    screen.blit(Replay.img,(Replay.x,Replay.y))

  if Page == "Player2Win":
    screen.fill((50,50,50))
    screen.blit(Player2Wins,(150,20))
    screen.blit(Replay.img,(Replay.x,Replay.y))
